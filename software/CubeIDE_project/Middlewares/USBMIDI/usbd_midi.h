...
#include "stm32f7xx_hal_conf.h"	//edit
#include "stm32f7xx_hal.h"	//edit

#define MIDI_OUT_JACK_NUM (8)
#define MIDI_IN_JACK_NUM (8)
#define MIDI_PORT_NUM (8)
...
#define USB_MIDI_CONFIG_DESC_SIZ                    69 + 16*MIDI_IN_JACK_NUM + 16*MIDI_OUT_JACK_NUM//325 when 8IO.default is 101. 133 when 2IN/2OUT.
