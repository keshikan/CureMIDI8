...
extern void cureRingBufferU8Flush(RingBufferU8 *rbuf);
...
/////////////////////////////
extern BUFFER_STATUS cureRingBufferU32Init(RingBuffer32 *rbuf, uint32_t buflen);
...
extern BUFFER_STATUS cureRingBufferU32GetElement(RingBuffer32 *rbuf, uint32_t *ret, uint32_t delaynum, uint32_t delay_buffer_length);
